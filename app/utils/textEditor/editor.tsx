...
const Editor: React.FC<EditorTypes> = ({ setValue, value, wwidth, hheight, quillRef }) => {
  ...
  const modules = useMemo(
    () => ({
      toolbar: {
        container: [["bold", "italic", "underline", "strike"], ["video", "image"], ["clean"]],
        handlers: {
          image: imageHandler,
        },
      },
  ...
  const formats = ["bold", "italic", "underline", "strike", "video", "image"]
