...
import { useMutation, useRouter, useQuery, useParam, Link } from "blitz"
...
const Tags = () => {
  ...
  TagValues = values
  teamTags.teamTags.map((teamTag) => existingTeamTags.push(teamTag.id))
...
export default Tags
/** let NameonlyLetters = name.replace(/[^a-zA-Z]/gm, "").toLocaleLowerCase() as string
