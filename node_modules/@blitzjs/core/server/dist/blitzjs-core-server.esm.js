import { _ as _createForOfIteratorHelperLoose, a as _extends, k as COOKIE_ANONYMOUS_SESSION_TOKEN, l as COOKIE_SESSION_TOKEN, m as COOKIE_REFRESH_TOKEN, g as HEADER_CSRF, j as SESSION_TOKEN_VERSION_0, h as HANDLE_SEPARATOR, i as SESSION_TYPE_ANONYMOUS_JWT, S as SESSION_TYPE_OPAQUE_TOKEN_SIMPLE, T as TOKEN_SEPARATOR, b as COOKIE_CSRF_TOKEN, H as HEADER_PUBLIC_DATA_TOKEN, C as COOKIE_PUBLIC_DATA_TOKEN, f as HEADER_CSRF_ERROR, d as HEADER_SESSION_REVOKED, e as HEADER_SESSION_CREATED } from '../../dist/constants-9247c749.esm.js';
import { getConfig, getProjectRoot } from '@blitzjs/config';
import { log, baseLogger, chalk } from '@blitzjs/display';
import { PaginationArgumentError, AuthenticationError, AuthorizationError, CSRFTokenMismatchError } from 'next/stdlib';
...
import '../../dist/blitz-data-e8ab5731.esm.js';
import 'htmlescape';
import 'react';
...
var getDb = function getDb() {
  ...
  var path = join(projectRoot, ".next/server/blitz-db.js");
...
async function setPublicDataForUser(userId, data) {
  ...
  for (var _iterator3 = _createForOfIteratorHelperLoose(sessions), _step3; !(_step3 = _iterator3()).done;) {
    var session = _step3.value;
    // Merge data
    var publicData = JSON.stringify(_extends({}, JSON.parse(session.publicData || ""), data));
    await global.sessionConfig.updateSession(session.handle, {
      publicData: publicData
    });
  }
...
export { SecurePassword, connectMiddleware, fixNodeFileTrace, generateToken, getAllMiddlewareForModule, getSession, handleRequestWithMiddleware, hash256, invokeWithMiddleware, isLocalhost, paginate, passportAuth, resolver, rpcApiHandler, sessionMiddleware, setPublicDataForUser, simpleRolesIsAuthorized, withFixNodeFileTrace };
