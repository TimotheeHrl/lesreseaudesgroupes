...
export declare type RedirectAuthenticatedTo = string | RouteUrlObject | false;
export declare type RedirectAuthenticatedToFnCtx = {
    session: PublicData;
};
export declare type RedirectAuthenticatedToFn = (args: RedirectAuthenticatedToFnCtx) => RedirectAuthenticatedTo;
